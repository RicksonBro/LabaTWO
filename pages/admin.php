  ...
  <header>
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white">
        ...
        <nav class="my-2 my-md-0 mr-md-3">
            <a class="btn btn-outline-primary btn-lg" href="/pages/restricted.php">Back</a>
        </nav>
    </div>
  </header>
  <div class="container">
    <section class="overlay">
        ...
        <form action="" method="post">
          ...
          <br><br>
          <nav class="my-2 my-md-0 mr-md-3">
              <input id="submit" class="btn btn-primary btn-lg" name="submit" type="submit" value="Edit">
              <a class="btn btn-dark btn-lg" href="">Delete</a>
          </nav>
        </form>
    </section>
  </div>
