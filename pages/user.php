  ...
  <header>
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white">
        ...
        <nav class="my-2 my-md-0 mr-md-3">
            ...
            ?>
            <a class="btn btn-outline-primary btn-lg" href="<?php echo $url; ?>">Back</a>
        </nav>
    </div>
  </header>
  <div class="container">
...
" class="rounded" alt="Place your photo">
                <form action="../upload.php?id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data">
                  ...
                  <br><br>
                  <input class="btn btn-sm btn-primary btn-lg" type="submit" value="Upload Image" name="submit"><br>
                </form>
                <form action="../user_edit_delete.php?id=<?php echo $_GET['id']; ?>" method="post">
                  ...
                  <br><br>
                  <nav class="my-2 my-md-0 mr-md-3">
                      <input id="submit" class="btn btn-primary btn-lg" name="user_edit" type="submit" value="Edit">
                      <input id="submit" class="btn btn-dark btn-lg" name="user_delete" type="submit" value="Delete">
                  </nav>
                </form>
                <?php
              }
