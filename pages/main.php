  ...
  <header>
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white">
        ...
        <nav class="my-2 my-md-0 mr-md-3">
            <button type="button" class="btn btn-outline-primary btn-lg" data-toggle="modal" data-target="#exampleModal">Sign In</button>
            <a class="btn btn-primary btn-lg" href="registration.php">Sign Up</a>
        </nav>
    </div>
            ...
            <div class="container">
              <section class="overlay">
                  <form action="../auth.php" method="post">
                    ...
                    <input id="submit" class="btn btn btn-primary btn-lg" name="submit" type="submit" value="Submit">
                  </form>
