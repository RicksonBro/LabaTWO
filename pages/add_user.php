...
<body>
  <header>
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white">
        ...
        <h4 class="my-0 mr-md-auto font-weight-normal"> </h4>
        <h4 class="my-0 mr-md-auto font-weight-normal"> </h4>
        <a class="my-0 mr-md-left font-weight-normal btn btn-outline-primary btn-lg" href="restricted_admin.php?id=<?php echo $_GET['id']; ?>">Back</a>
    </div>
  </header>
  <div class="container">
    <section class="overlay">
        ...
        <form action="../add.php?id=<?php echo $_GET['id']; ?>" method="post">
          ...
          <br><br>
          <input id="submit" class="btn btn-primary btn-lg" name="submit" type="submit" value="Submit">
        </form>
    </section>
  </div>
</body>
