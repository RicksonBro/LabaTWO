  ...
  <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white">
    ...
    <h5 class="my-0 mr-md-auto font-weight-normal"> </h5>
      <nav class="my-2 my-md-0 mr-md-3">
          <a class="btn btn-primary btn-lg" href="user.php?id=<?php echo $_GET['id']; ?>"><?php echo $name; ?></a>
          <a class="btn btn-secondary btn-lg" href="../logout.php">Sign Out</a>
      </nav>
  </div>
</header>
<div class="container">
    ...
    <br>
    <a class="btn btn-primary btn-lg" href="add_user.php?id=<?php echo $_GET['id']; ?>">Add user</a>
    <a class="btn btn-primary btn-lg" href="edit_delete.php?id=<?php echo $_GET['id']; ?>">Edit user</a>
    <?php
    else:
    ?>
